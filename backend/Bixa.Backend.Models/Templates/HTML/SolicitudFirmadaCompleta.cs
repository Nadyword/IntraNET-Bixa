...
public class SolicitudFirmadaCompleta
{
    private readonly string bodyMail = """
        ...
        <head>
            ...
            <title>Solicitud Firmada por Todos los Aprobadores - BIXA</title>
        </head>
                        ...
                        <table role="presentation" style="width: 100%; max-width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1);">
                            ...
                            <tr>
                                <td style="padding: 40px 30px;">
                                    <h2 style="margin: 0 0 20px 0; color: #333333; font-size: 24px; font-weight: 600; text-align: center;">Solicitud lista para aprobación final</h2>

                                    <p style="margin: 0; color: #666666; font-size: 16px; line-height: 1.6; text-align: center;">
                                        Una solicitud del Portal Corporativo BIXA ha sido firmada por todos sus aprobadores y está pendiente de tu aprobación final. Ingresa al portal para revisarla.
                                    </p>
                                </td>
                            </tr>
                            <tr>
