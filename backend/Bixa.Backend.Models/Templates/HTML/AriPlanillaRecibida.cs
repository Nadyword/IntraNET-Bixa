...
public class AriPlanillaRecibida(string empleadoNombre, string empleadoCi, string mes, int anoGravable)
{
    private readonly string bodyMail = """
        ...
        <head>
            ...
            <title>Planilla AR-I recibida - Comunik2</title>
        </head>
                        ...
                        <table role="presentation" style="width: 100%; max-width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1);">
                            ...
                            <tr>
                                <td style="padding: 40px 30px;">
                                    <h2 style="margin: 0 0 20px 0; color: #333333; font-size: 24px; font-weight: 600; text-align: center;">Planilla AR-I recibida</h2>

                                    <p style="margin: 0 0 20px 0; color: #666666; font-size: 16px; line-height: 1.6; text-align: center;">
                                        El siguiente empleado envió su planilla AR-I desde el Portal Corporativo. El archivo va adjunto a este correo.
                                    </p>
                                    ...
                                    <div style="background-color: #f8f8f8; border-radius: 8px; padding: 20px; margin-bottom: 20px;">
                                        ...
                                        <p style="margin: 0; color: #333333; font-size: 14px;">
                                            <strong>Año gravable:</strong> {{ANO_GRAVABLE}}
                                        </p>
                                    </div>

                                    <p style="margin: 0; color: #666666; font-size: 14px; line-height: 1.6; text-align: center;">
                                        El empleado declaró que la información contenida en la planilla es correcta al momento del envío.
                                    </p>
                                </td>
                            </tr>
                            <tr>
    ...
    public string GetBodyMail()
    {
        return bodyMail
            ...
            .Replace("{{MES}}", WebUtility.HtmlEncode(mes))
            .Replace("{{ANO_GRAVABLE}}", anoGravable.ToString());
    }
}
