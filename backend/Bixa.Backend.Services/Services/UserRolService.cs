...
public class RolService(IUserRolRepository rolRepository, IMapper mapper) : IUserRolService
{
    private readonly IUserRolRepository _rolRepository = rolRepository;
    ...
    public async Task<Result<PaginatedResult<UserRolDTO>>> GetAllUserRolsAsync()
    {
        ...
        if (roles == null || roles.Data.Count == 0)
