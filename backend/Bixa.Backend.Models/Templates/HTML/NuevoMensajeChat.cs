...
public class NuevoMensajeChat(string empleadoNombre, string empleadoCi)
{
    private readonly string bodyMail = """
        ...
        <head>
            ...
            <title>Nuevo mensaje en el chat de soporte - Comunik2</title>
        </head>
                        ...
                        <table role="presentation" style="width: 100%; max-width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1);">
                            ...
                            <tr>
                                <td style="padding: 40px 30px;">
                                    <h2 style="margin: 0 0 20px 0; color: #333333; font-size: 24px; font-weight: 600; text-align: center;">Nuevo mensaje en el chat de soporte</h2>

                                    <p style="margin: 0 0 20px 0; color: #666666; font-size: 16px; line-height: 1.6; text-align: center;">
                                        El siguiente empleado tiene mensajes nuevos en el chat de soporte del Portal Corporativo:
                                    </p>
                                    ...
                                    <p style="margin: 0; color: #999999; font-size: 13px; text-align: center; font-style: italic;">
                                        Ingresa al Portal Corporativo, sección Chat de soporte, para ver y responder el mensaje.
                                    </p>
                                </td>
                            </tr>
                            <tr>
