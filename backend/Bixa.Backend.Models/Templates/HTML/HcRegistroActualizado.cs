...
public class HcRegistroActualizado(string empleadoNombre, string empleadoCi)
{
    private readonly string bodyMail = """
        ...
        <head>
            ...
            <title>Registro de HC actualizado - Comunik2</title>
        </head>
                        ...
                        <table role="presentation" style="width: 100%; max-width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1);">
                            ...
                            <tr>
                                <td style="padding: 40px 30px;">
                                    <h2 style="margin: 0 0 20px 0; color: #333333; font-size: 24px; font-weight: 600; text-align: center;">Registro de HC actualizado</h2>

                                    <p style="margin: 0 0 20px 0; color: #666666; font-size: 16px; line-height: 1.6; text-align: center;">
                                        El siguiente empleado actualizó los valores de Mes 1 / Mes 2 / Mes 3 de su registro de HC en el Portal Corporativo:
                                    </p>
                                    ...
                                    <p style="margin: 0; color: #999999; font-size: 13px; text-align: center; font-style: italic;">
                                        Puedes revisar el detalle en el Portal del Líder, sección HC.
                                    </p>
                                </td>
                            </tr>
                            <tr>
